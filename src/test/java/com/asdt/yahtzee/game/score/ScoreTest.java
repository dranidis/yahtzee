...
public class ScoreTest {
    ...
    public void someScores() {
        ...
        int score1 = ScoreFactory.getInstance().getScoreStrategy("1s").calculate(kept);
        assertEquals("1s category: 1 2 1 6 1 scores 3", 3, score1);

        int score2 = ScoreFactory.getInstance().getScoreStrategy("2s").calculate(kept);
        assertEquals("2s category: 1 2 1 6 1 scores 2", 2, score2);

        int score3 = ScoreFactory.getInstance().getScoreStrategy("3s").calculate(kept);
        assertEquals("3s category: 1 2 1 6 1 scores 0", 0, score3);

        int score4 = ScoreFactory.getInstance().getScoreStrategy("4s").calculate(kept);
        assertEquals("4s category: 1 2 1 6 1 scores 0", 0, score4);

        int score5 = ScoreFactory.getInstance().getScoreStrategy("5s").calculate(kept);
        assertEquals("5s category: 1 2 1 6 1 scores 0", 0, score5);

        int score6 = ScoreFactory.getInstance().getScoreStrategy("6s").calculate(kept);
        assertEquals("6s category: 1 2 1 6 1 scores 6", 6, score6);

        int score3k = ScoreFactory.getInstance().getScoreStrategy("3k").calculate(kept);
        assertEquals("3K category: 1 2 1 6 1 scores total:11", 11, score3k);

        int score4k = ScoreFactory.getInstance().getScoreStrategy("4k").calculate(kept);
        assertEquals("4K category: 1 2 1 6 1 scores total:0", 0, score4k);

        int scorefh = ScoreFactory.getInstance().getScoreStrategy("fh").calculate(kept);
        assertEquals("FH category: 1 2 1 6 1 scores 0", 0, scorefh);

        int scorech = ScoreFactory.getInstance().getScoreStrategy("ch").calculate(kept);
        assertEquals("change category: 1 2 1 6 1 scores 11", 11, scorech);

        int scoreS4 = ScoreFactory.getInstance().getScoreStrategy("ch").calculate(kept);
    ...
    public void FourkScore() {
        ...
        int score5k = ScoreFactory.getInstance().getScoreStrategy("5k").calculate(kept);
    ...
    public void SSequenceScore() {
        ...
        int scoreS4 = ScoreFactory.getInstance().getScoreStrategy("s4").calculate(kept);
